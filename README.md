...
[![Lemon Terminal](https://shields.io)](https://github.com/MihanPROJECTS/lemon-terminal) - Простой и быстрый терминал с кастомным GUI, множеством команд и удобным интерфейсом. Проект в активной стадии разрботки, недавно был релиз.
